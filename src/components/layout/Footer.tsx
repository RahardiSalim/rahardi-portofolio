      ...
      <div className="container-custom py-24">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
          <div className="md:col-span-6">
            <h2 className="text-4xl font-black mb-8 tracking-tighter uppercase">RS<span className="text-blue-500">.</span></h2>
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex gap-6">
              <a 
                ...
                aria-label="GitHub"
              >
                <svg className="w-6 h-6 fill-current text-gray-400 group-hover:text-white transition-colors" viewBox="0 0 24 24">
