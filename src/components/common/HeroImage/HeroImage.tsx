  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={{ duration: 0.6, ease: [0.25, 1, 0.5, 1] }}
      >
        <Image src="/assets/images/profil_formal.png" alt="Rahardi Salim - Professional" fill className="object-cover" priority />
      </motion.div>
      <motion.div
        className="absolute inset-0 rounded-2xl overflow-hidden border-4 border-black dark:border-white"
        ...
        transition={{ duration: 0.6, ease: [0.25, 1, 0.5, 1] }}
      >
        <Image src="/assets/images/profil_ui.png" alt="Rahardi Salim - Casual" fill className="object-cover" />
      </motion.div>
      <motion.div
